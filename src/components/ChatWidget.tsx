    ...
    <>
      ...
      >
        <Button
          ...
          size="lg"
          className="h-16 w-16 rounded-full bg-primary hover:bg-primary/90 glow-primary shadow-2xl"
        >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 w-96 h-[500px] glass rounded-2xl shadow-2xl overflow-hidden z-50"
          >
            {/* Header */}
